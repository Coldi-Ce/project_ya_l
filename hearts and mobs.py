    ...
    class Hero(pygame.sprite.Sprite):
        ...
        def update(self):
            ...
            if pygame.sprite.spritecollideany(self, exit1):
                flag = True
            if pygame.sprite.spritecollide(self, all_spiders,
                                           False) and pygame.time.get_ticks() - self.last_death > 1200:
